...
const CommentForm = ({onSubmit}: CommentFormProps) => {
  ...
  const onSubmitForm = (e:  React.FormEventHandler<HTMLFormElement>) => {
    e.preventDefault()
  ...
  return (
    <form onSubmit={onSubmitForm}>
      ...
      <div className="field">
        ...
        <div className="control">
          <textarea className="textarea" placeholder="Textarea" value={body} onChange={(e) => setBody(e.target.value)}></textarea>
        </div>
      </div>
